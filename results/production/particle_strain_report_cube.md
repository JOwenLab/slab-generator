...
* **Lattice strain = -0.2007 %** (linear, tr(eps)/3) at R = 1.500 nm -> **contracts**
* **Lattice parameter a = 3.565827 A** vs unstrained a0 = 3.572997 A (delta_a = -0.007171 A)
* Interior pressure = +2.66116 GPa (compressive-positive)

Every quantity here scales as 1/R exactly; the companion `..._size_sweep_*.csv` tabulates that curve.

## Inputs

* Shape: **cube**, facet area fractions (100) 1.0000
...
```
    -2.66116    -0.00000    -0.00000
    -0.00000    -2.66116    -0.00000
    -0.00000    -0.00000    -2.66116
```

Hydrostatic pressure (compressive-positive): **+2.66116 GPa**
In the project/QE convention (positive = compressed) the same tensor is diag(+2.66116, +2.66116, +2.66116) GPa.

Interior strain (dimensionless, negative = compression):

```
    -2.007e-03    +0.000e+00    +0.000e+00
    +0.000e+00    -2.007e-03    +0.000e+00
    +0.000e+00    +0.000e+00    -2.007e-03
```
...
| --- | ---: | ---: | ---: |
| [111] | -2.007e-03 | +21.153 .. +34.987 | 0.0000 .. 0.0000 |
| [1-1-1] | -2.007e-03 | +21.153 .. +34.987 | 0.0000 .. 0.0000 |
| [-11-1] | -2.007e-03 | +21.153 .. +34.987 | 0.0000 .. 0.0000 |
| [-1-11] | -2.007e-03 | +21.153 .. +34.987 | 0.0000 .. 0.0000 |

### Per parameter set

| param set | NV axis | Delta D (MHz) | E (MHz) | f+ (MHz) | f- (MHz) |
| --- | --- | ---: | ---: | ---: | ---: |
| udvarhelyi2018_dft | [111] | +21.153 | 0.0000 | 2891.15 | 2891.15 |
| udvarhelyi2018_dft | [1-1-1] | +21.153 | 0.0000 | 2891.15 | 2891.15 |
| udvarhelyi2018_dft | [-11-1] | +21.153 | 0.0000 | 2891.15 | 2891.15 |
| udvarhelyi2018_dft | [-1-11] | +21.153 | 0.0000 | 2891.15 | 2891.15 |
| barson2017_scaled | [111] | +34.987 | 0.0000 | 2904.99 | 2904.99 |
| barson2017_scaled | [1-1-1] | +34.987 | 0.0000 | 2904.99 | 2904.99 |
| barson2017_scaled | [-11-1] | +34.987 | 0.0000 | 2904.99 | 2904.99 |
| barson2017_scaled | [-1-11] | +34.987 | 0.0000 | 2904.99 | 2904.99 |

* Delta D over all axes and all parameter sets: **+21.153 .. +34.987 MHz** (1.65x from the coupling set alone)
